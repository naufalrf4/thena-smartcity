                    ...
                    <div class="card-body">
                        <div class="position-relative">
                            ...
                            @if (session('role')->level_role !== 6)
                                ...
                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light mb-2 me-2"
                                    onclick="window.location.href='{{ route('pelaporan.exportPdf') }}'">
        ...
        <div class="modal fade new-customer" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" method="POST" action="{{ route('pelaporan.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukkan Judul Laporan"
                                            name="judul_laporan" id="NewPelaporan-Username">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" placeholder="Select Date"
                                            name="tanggal_kejadian" id="customers-date">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" placeholder="Tambahkan Foto"
                                            name="foto_kejadian" id="NewPelaporan-Phone">
                                    </div>
                                </div>
                                <!-- <div class="col-md-12">
                                        <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select required class="form-select form-control" id="kelurahan_id"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="NewPelaporan-Address">Alamat Lengkap Kejadian (cth:
                                            Nama Gedung, Nomor dan Nama Jalan, RT dan RW)</label>
                                        <input type="text" class="form-control" name="alamat_kejadian"
                                            placeholder="Masukan Alamat Lengkap (cth: Nama Gedung, Nomor dan Nama Jalan, RT dan RW)"
                ...
                fetch(apiUrl)
                    ...
                    .then((data) => {
                        ...
                        if (data.results.length > 0) {
                            ...
                            $('#NewPelaporan-Address').attr("placeholder",
                                "Masukan Alamat Lengkap (cth: Nama Gedung, Nomor dan Nama Jalan, RT dan RW)");
                        }
            ...
            new gridjs.Grid({
                columns: [{
...

                    {
                        ...
                        formatter: (function(cell) {
                            return gridjs.html('<span class="font-size-12">#LPR' + cell[0] + '</span><br>' +
                                cell[1] + '<br> <a href="#" class="text-body"> Kec. ' + cell[2] +
                                "</a>" + '<br> <a href="#" class="text-body"> Kel. ' + cell[3] + "</a>");
                        })
                    },
                    {
                        name: "Status Pengerjaan",
                        formatter: (function(cell) {
                            return gridjs.html('<span class="badge bg-' + cell[1] + ' font-size-12">' +
                                cell[0] + '</span>');
                        })
                    },
                    // "Estimasi Selesai", 
                ...
                server: {
                    ...
                    then: data => {
                        ...
                        return data.pelaporan.map(laporan => [
                            "",
                            [laporan.id, laporan.tgl_dibuat, laporan.kecamatan.nama, laporan.kelurahan
                                .nama
                            ],
