                        ...
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <div class="p-2 mt-4">
                                        <form method="POST" action="{{ route('register') }}" class="auth-input" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">Email<span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">Nama<span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">Password<span class="text-danger">*</span></label>
                                                        <input type="password" class="form-control" placeholder="Masukkan Password"  minlength="8" required
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">Konfirmasi Password<span class="text-danger">*</span></label>
                                                        <input type="password" class="form-control" placeholder="Masukkan Ulang Password" minlength="8" required
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">Username<span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">Nomor Telephone<span class="text-danger">*</span></label>
                                                        <input type="number" class="form-control" placeholder="Masukkan Nomor Telephone" required
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Category">Kecamatan<span class="text-danger">*</span></label>
                                                        <select required class="form-select form-control" id="kecamatan_id" name="kecamatan_id"  required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Category">Kelurahan<span class="text-danger">*</span></label>
                                                        <select required class="form-select form-control" id="kelurahan_id" name="kelurahan_id" disabled  required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">RT<span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="CreateTask-Task-Name">RW<span class="text-danger">*</span></label>
