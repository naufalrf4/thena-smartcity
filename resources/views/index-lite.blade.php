                        ...
                        <div class="col-lg-9">
                            <div class="text-center">
								...
								>Jalanan Rusak</span>
                                    ...
                                    <a href="/dashboard" class="btn btn-lg btn-gradient-1" data-aos="fade-up-sm" data-aos-delay="200">Lapor Sekarang</a>
                                </div>
                        ...
                        <div class="col-lg-7" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="content">
                                ...
                                <p class="mb-6" style="text-align: justify;">
                                    ...
                                    Aplikasi <span class="text-gradient-1 fw-bold">Semapor (Semarang Lapor)</span> merupakan solusi modern untuk memperkuat partisipasi masyarakat dalam membangun Kota Semarang yang lebih baik. Dengan fokus pada pelaporan dan pemantauan permasalahan di Kota Semarang, aplikasi ini dirancang untuk memberikan kemudahan akses melalui platform berbasis website.
                                    <!-- <br><br>
                    ...
                    <div class="row g-6 g-xl-14">
                        <div class="col-lg-4" data-aos="fade-up-sm" data-aos-delay="200">
                            <div class="d-flex flex-column gap-6 flex-lg-row">
                                <div class="icon w-14 h-14 flex-shrink-0 d-flex align-center justify-center rounded-3 p-2 border bg-primary bg-opacity-10 text-primary-2 border-primary border-opacity-25">
            ...
            <!-- <section class="bg-striped bg-striped-sm bg-striped-bottom bg-lite-blue py-20 py-lg-30">
                <div class="container">
                    <div class="row justify-center mb-18">
                        <div class="col-lg-9">
                            <div class="text-center">
                                <p class="text-primary-2" data-aos="fade-up-sm" data-aos-delay="50">
                                    GenAI Use Cases
                                </p>
                        ...
                        <div class="col-lg-10">
                            <div class="text-center">
                                <h1 class="fw-bold text-center" data-aos="fade-up-sm" data-aos-delay="50">
                                    Pendiri <span class="text-gradient-1">Semapor</span>
                                </h1>
                                ...
                                <div class="review-card rounded h-full p-6 border bg-lite-blue border-lite-blue-4">
                                    ...
                                    <div class="">
                                        <div class="stars d-flex items-center gap-1 mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 14" class="w-4 h-4 text-primary-2">
                            ...
                            <div class="col-lg-10">
                                <div class="text-center pt-6 px-6 pt-md-10 px-md-10 pt-lg-18 px-lg-18">
                                    ...
                                    <div class="cta-image-container mt-10">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 34 90" class="text-primary-2 arrow-shape">
        ...
        <footer class="footer bg-striped pt-10 pt-lg-15">
            <div class="container">
                ...
                <div class="text-center py-6 mt-8">
                    <p class="fs-sm mb-0">Seluruh Hak Cipta &copy; 2024 | <span class="text-primary-2 fw-bold"> Semapor</span></p>
                </div>
            </div>
        </footer>
